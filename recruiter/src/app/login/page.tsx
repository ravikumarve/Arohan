        ...
        <div className="bg-recruiter-background-secondary rounded-lg p-8 border border-recruiter-background-tertiary">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={cn("w-full py-3 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2", isLoading ? "bg-recruiter-primary/70 cursor-not-allowed" : "bg-recruiter-primary hover:bg-recruiter-primary-dark")}
            >
