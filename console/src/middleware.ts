...
// To enable authentication, uncomment the authentication checks below
...
export function middleware(request: NextRequest) {
  ...
  // DISABLED FOR TESTING: Allow all paths without authentication
  ...
  // DISABLED FOR TESTING: Allow admin routes without role check
