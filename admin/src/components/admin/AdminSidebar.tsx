  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-primary rounded-lg text-foreground"
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center gap-3 p-6 border-b border-border">
            ...
            <div>
              <h1 className="text-lg font-bold text-foreground">AROHAN</h1>
              ...
              return (
                <Link
                  ...
                  className={`
                    ...
                    ${
                      isActive
                        ? 'bg-gradient-to-r from-admin-primary/20 to-admin-primary/10 text-foreground border border-admin-primary/30'
